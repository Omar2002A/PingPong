...
while True:
    ...
    ball.sety(ball.ycor() + ball.dy) #ball starts at 0 and everytime loops run--->+0.25 x-axis
    ...
    if (ball.xcor() > 340 and ball.xcor() < 350) and (ball.ycor() < madrab2.ycor() + 49.9 and ball.ycor() > madrab2.ycor() - 49.9):
        ball.setx(340)
        ball.dx *= -1

    if (ball.xcor() < -340 and ball.xcor() > -350) and (ball.ycor() < madrab1.ycor() + 49.9 and ball.ycor() > madrab1.ycor() - 49.9):
        ball.setx(-340)
        ball.dx *= -1
